        ...
        <div className="container ">
          ...
          <div className=" d-flex justify-content-center align-items-center flex-lg-row">
            <div className="border border-dark rounded  col-md-8 col-lg-5 bg-f p-5 ">
              <h5 className="mb-3 fs-1 text-dark" id="head">
                {" "}
                Login{" "}
              </h5>
          ...
          <div className="mt-3">
            <button
              className="btn btn-sm fs-5 mx-3 px-4 btn-color text-white mt-3"
            ...
            <span className="mt-3">
              <button
                className="btn btn-sm fs-5 mx-3 btn-color text-white mt-3 "
